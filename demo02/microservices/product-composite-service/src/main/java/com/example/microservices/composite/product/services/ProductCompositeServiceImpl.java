...
import com.example.api.composite.product.ServiceAddresses;
...
public class ProductCompositeServiceImpl implements ProductCompositeService {
	...
	private ProductAggregate createProductAggregate(Product product, List<Recommendation> recommendations,
		...
		List<ReviewSummary> reviewSummaries = reviews == null 
				? null
				: reviews.stream().map(r -> new ReviewSummary(r.getReviewId(), r.getAuthor(), r.getSubject(), r.getContent())).collect(Collectors.toList());
